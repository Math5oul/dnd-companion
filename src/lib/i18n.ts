...
const translations = {
  pt: {
    ...
    importSuccess: (name: string) => `Personagem ${name} importado com sucesso!`,
    importError: 'Arquivo inválido ou corrompido.',
    newCharModalTitle: 'Adicionar Personagem',
    createNewChar: '✏️ Criar Novo Personagem',
  ...
  en: {
    ...
    importSuccess: (name: string) => `Character ${name} imported successfully!`,
    importError: 'Invalid or corrupted file.',
    newCharModalTitle: 'Add Character',
    createNewChar: '✏️ Create New Character',
